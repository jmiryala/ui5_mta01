		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 Sample Application",
									"targetURL": "#jhrabtpdevopsui5module01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"jhrabtpdevopsui5module01-display": {
								"semanticObject": "jhrabtpdevopsui5module01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jhra.btpdevops.ui5module01",
									"url": sap.ui.require.toUrl("jhra/btpdevops/ui5module01")
								}
							}
						}
					}
